...
import 'package:eliud_pkg_shop/model/cart_item_form_bloc.dart';
  ...
  Widget build(BuildContext context) {
    ...
    if (formAction == FormAction.ShowData) {
      return BlocProvider<CartItemFormBloc >(
            create: (context) => CartItemFormBloc(AccessBloc.appId(context),
...
class _MyCartItemFormState extends State<MyCartItemForm> {
  ...
  bool _readOnly(AccessState accessState, CartItemFormInitialized state) {
