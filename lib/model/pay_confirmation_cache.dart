...
class PayConfirmationCache implements PayConfirmationRepository {
  ...
  @override
  StreamSubscription<List<PayConfirmationModel>> listen(trigger, {String currentMember, String orderBy, bool descending}) {
    return reference.listen(trigger, currentMember: currentMember, orderBy: orderBy, descending: descending);
  }

  @override
  StreamSubscription<List<PayConfirmationModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending}) {
