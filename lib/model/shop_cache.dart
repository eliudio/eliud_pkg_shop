...
class ShopCache implements ShopRepository {
  ...
  @override
  StreamSubscription<List<ShopModel>> listen(trigger, {String currentMember, String orderBy, bool descending, ReadCondition readCondition, int privilegeLevel}) {
  ...
  @override
  StreamSubscription<List<ShopModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending, ReadCondition readCondition, int privilegeLevel}) {
