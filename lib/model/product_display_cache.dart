...
class ProductDisplayCache implements ProductDisplayRepository {
  ...
  @override
  StreamSubscription<List<ProductDisplayModel>> listen(trigger, {String currentMember, String orderBy, bool descending, int privilegeLevel}) {
  ...
  @override
  StreamSubscription<List<ProductDisplayModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending, int privilegeLevel}) {
