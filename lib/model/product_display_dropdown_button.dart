...
typedef ProductDisplayChanged(String? value);
...
class ProductDisplayDropdownButtonWidget extends StatefulWidget {
  ...
  ProductDisplayDropdownButtonWidget({ this.value, this.trigger, this.optional, Key? key }): super(key: key);
...
List<Widget> widgets(ProductDisplayModel pm) {
var widgets = <Widget>[];
      ...
      if (state is ProductDisplayListLoading) {
        ...
        DropdownButton button = 
                    DropdownButton<String>(
                      ...
                      items: items,
                      value: valueChosen,
                      hint: Text('Select a productDisplay'),
