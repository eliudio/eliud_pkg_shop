...
typedef ShopChanged(String? value, int? privilegeLevel,);
...
class ShopDropdownButtonWidget extends StatefulWidget {
  ...
  ShopDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);
