...
typedef PayWidgetProvider(PayModel? value);

class PayListWidget extends StatefulWidget with HasFab {
  AppModel app;
  BackgroundModel? listBackground;
  PayWidgetProvider? widgetProvider;
  bool? readOnly;
  String? form;
  PayListWidgetState? state;
  bool? isEmbedded;

  PayListWidget({ Key? key, required this.app, this.readOnly, this.form, this.widgetProvider, this.isEmbedded, this.listBackground }): super(key: key);
    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return PayListItem(app: widget.app,
            value: value,
//            app: accessState.app,
