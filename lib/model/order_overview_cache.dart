...
class OrderOverviewCache implements OrderOverviewRepository {
  ...
  @override
  StreamSubscription<List<OrderOverviewModel>> listen(trigger, {String currentMember, String orderBy, bool descending, ReadCondition readCondition, int privilegeLevel}) {
  ...
  @override
  StreamSubscription<List<OrderOverviewModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending, ReadCondition readCondition, int privilegeLevel}) {
