...
class OrderOverviewCache implements OrderOverviewRepository {
  ...
  @override
  StreamSubscription<List<OrderOverviewModel>> listen(trigger, {String currentMember, String orderBy, bool descending}) {
    return reference.listen(trigger, currentMember: currentMember, orderBy: orderBy, descending: descending);
  }

  @override
  StreamSubscription<List<OrderOverviewModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending}) {
