...
class OrderComponentSelector extends ComponentSelector {
  ...
  Widget createSelectWidget(BuildContext context, AppModel app, int privilegeLevel, double height,
    ...
    return BlocProvider<OrderListBloc>(
      ...
      child: SelectOrderWidget(app: app,
          height: height,
...
class SelectOrderWidget extends StatefulWidget {
  ...
  @override
  _SelectOrderWidgetState createState() {
    return _SelectOrderWidgetState();
  }
}

class _SelectOrderWidgetState extends State<SelectOrderWidget> with TickerProviderStateMixin {
