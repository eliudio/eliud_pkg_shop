...
class CartComponentSelector extends ComponentSelector {
  ...
  Widget createSelectWidget(BuildContext context, AppModel app, int privilegeLevel, double height,
    ...
    return BlocProvider<CartListBloc>(
      ...
      child: SelectCartWidget(app: app,
          height: height,
...
class SelectCartWidget extends StatefulWidget {
  final AppModel app;
  final double height;
  ...
  @override
  _SelectCartWidgetState createState() {
    return _SelectCartWidgetState();
  }
}

class _SelectCartWidgetState extends State<SelectCartWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<CartListBloc>(context).add(
            CartChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID!)));
    }
  }
