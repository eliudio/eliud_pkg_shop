...
class ProductCache implements ProductRepository {
  ...
  @override
  StreamSubscription<List<ProductModel>> listen(trigger, { String orderBy, bool descending }) {
    return reference.listen(trigger, orderBy: orderBy, descending: descending);
  }

  @override
  StreamSubscription<List<ProductModel>> listenWithDetails(trigger, {String orderBy, bool descending }) {
