...
class SelectPayWidget extends StatefulWidget {
  ...
  @override
  _SelectPayWidgetState createState() {
    return _SelectPayWidgetState();
  }
}

class _SelectPayWidgetState extends State<SelectPayWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<PayListBloc>(context).add(
            PayChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID!)));
    }
  }
