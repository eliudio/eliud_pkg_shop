...
class ProductDisplayListWidget extends StatefulWidget with HasFab {
  ...
  ProductDisplayListWidget({ Key key, this.readOnly, this.form, this.widgetProvider, this.isEmbedded, this.listBackground }): super(key: key);
...
class ProductDisplayListWidgetState extends State<ProductDisplayListWidget> {
  ...
  Widget fab(BuildContext aContext, AccessState accessState) {
    if (accessState is AppLoaded) {
      return !accessState.memberIsOwner() 
        ...
        heroTag: "ProductDisplayFloatBtnTag",
  ...
  Widget getForm(value, action) {
    if (widget.form == null) {
      return ProductDisplayForm(value: value, formAction: action);
    } else {
      return null;
    }
  }
  ...
  Widget build(BuildContext context) {
    return Dismissible(
      ...
      child: ListTile(
        onTap: onTap,
        title: Hero(
          tag: '${value.documentID}__ProductDisplayheroTag',
          child: Container(
