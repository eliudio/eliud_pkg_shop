...
typedef ProductDisplayWidgetProvider(ProductDisplayModel? value);

class ProductDisplayListWidget extends StatefulWidget with HasFab {
  AppModel app;
  BackgroundModel? listBackground;
  ProductDisplayWidgetProvider? widgetProvider;
  bool? readOnly;
  String? form;
  ProductDisplayListWidgetState? state;
  bool? isEmbedded;

  ProductDisplayListWidget({ Key? key, required this.app, this.readOnly, this.form, this.widgetProvider, this.isEmbedded, this.listBackground }): super(key: key);

  @override
  ProductDisplayListWidgetState createState() {
    state ??= ProductDisplayListWidgetState();
    return state!;
  }
      ...
      onPressed: () {
        Navigator.of(context).push(
          pageRouteBuilder(widget.app, page: BlocProvider.value(
              ...
              child: ProductDisplayForm(app:widget.app,
                  value: null,
    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return ProductDisplayListItem(app: widget.app,
            value: value,
//            app: accessState.app,
  ...
  Widget? getForm(value, action) {
    if (widget.form == null) {
      return ProductDisplayForm(app:widget.app, value: value, formAction: action);
    } else {
      return null;
    }
  }
