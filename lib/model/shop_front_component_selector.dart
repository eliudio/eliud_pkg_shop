...
class SelectShopFrontWidget extends StatefulWidget {
  ...
  @override
  _SelectShopFrontWidgetState createState() {
    return _SelectShopFrontWidgetState();
  }
}

class _SelectShopFrontWidgetState extends State<SelectShopFrontWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<ShopFrontListBloc>(context).add(
            ShopFrontChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID!)));
    }
  }
