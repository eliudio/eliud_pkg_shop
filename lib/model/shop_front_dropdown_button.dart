...
typedef ShopFrontChanged(String? value, int? privilegeLevel,);
...
class ShopFrontDropdownButtonWidget extends StatefulWidget {
  ...
  ShopFrontDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);
...
List<Widget> widgets(ShopFrontModel value) {
var app = widget.app;
var widgets = <Widget>[];
        ...
        return ListView(
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'shopFronts', widget.value, (newValue, _) {
                  setState(() {
