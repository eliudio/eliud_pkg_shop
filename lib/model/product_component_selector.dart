...
class ProductComponentSelector extends ComponentSelector {
  @override
  Widget createSelectWidget(BuildContext context, AppModel app, int privilegeLevel, double height,
    ...
    return BlocProvider<ProductListBloc>(
      ...
      child: SelectProductWidget(app: app,
          height: height,
...
class SelectProductWidget extends StatefulWidget {
  ...
  @override
  _SelectProductWidgetState createState() {
    return _SelectProductWidgetState();
  }
}

class _SelectProductWidgetState extends State<SelectProductWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<ProductListBloc>(context).add(
            ProductChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID!)));
    }
  }

  Widget theList(BuildContext context, List<ProductModel?> values) {
    var app = widget.app; 
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ProductListBloc, ProductListState>(
      ...
      if ((state is ProductListLoaded) && (state.values != null)) {
