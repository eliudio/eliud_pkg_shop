  ...
  Widget createSelectWidget(BuildContext context, AppModel app, int privilegeLevel, double height,
    ...
    return BlocProvider<OrderOverviewListBloc>(
          ...
          orderOverviewRepository:
              orderOverviewRepository(appId: appId)!,
          )..add(LoadOrderOverviewList()),
      child: SelectOrderOverviewWidget(app: app,
          height: height,
...
class SelectOrderOverviewWidget extends StatefulWidget {
  ...
  @override
  _SelectOrderOverviewWidgetState createState() {
    return _SelectOrderOverviewWidgetState();
  }
}

class _SelectOrderOverviewWidgetState extends State<SelectOrderOverviewWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<OrderOverviewListBloc>(context).add(
            OrderOverviewChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID!)));
    }
  }
