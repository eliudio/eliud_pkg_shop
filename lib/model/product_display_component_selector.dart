  ...
  Widget createSelectWidget(BuildContext context, AppModel app, int privilegeLevel, double height,
    ...
    return BlocProvider<ProductDisplayListBloc>(
          ...
          productDisplayRepository:
              productDisplayRepository(appId: appId)!,
          )..add(LoadProductDisplayList()),
      child: SelectProductDisplayWidget(app: app,
          height: height,
...
class SelectProductDisplayWidget extends StatefulWidget {
  ...
  @override
  _SelectProductDisplayWidgetState createState() {
    return _SelectProductDisplayWidgetState();
  }
}

class _SelectProductDisplayWidgetState extends State<SelectProductDisplayWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<ProductDisplayListBloc>(context).add(
            ProductDisplayChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID)));
    }
  }
